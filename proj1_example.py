...
def load_data(input_length):
    ...
    return train_data_matrix, train_data_label, test_data_matrix, None, vocab
...
if __name__ == '__main__':
    ...
    train_data_matrix, train_data_label, test_data_matrix, _, vocab = load_data(input_length)
